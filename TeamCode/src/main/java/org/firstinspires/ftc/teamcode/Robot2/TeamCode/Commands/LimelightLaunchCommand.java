...
public class LimelightLaunchCommand extends SequentialCommandGroup {
    public LimelightLaunchCommand(Launcher launcher, Turret turret, Intake intake, LimelightSubsystem limelight){
        addCommands(
