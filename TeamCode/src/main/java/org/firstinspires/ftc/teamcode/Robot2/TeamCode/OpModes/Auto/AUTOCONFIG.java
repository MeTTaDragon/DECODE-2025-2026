    ...
    public AUTOCONFIG() {
        super("Select a Tuning OpMode", s -> {
            s.folder("Blue", l -> {
                ...
                l.add("Far 6 bile", BlueFar6Balls::new);
                l.add("Far bile human", BlueFarHumanBalls::new);
            });
            s.folder("Red", a -> {
                a.add("Close 12 bile", RedClose12ball::new);
                a.add("Close 12 bile, gate dupa preload", RedClose12BallOpenGateAfterPreload::new);
                a.add("Far 6 bile", RedFar6Balls::new);
                a.add("Far bile human", RedFarHumanBalls::new);
            });
